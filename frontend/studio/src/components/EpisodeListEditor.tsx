...
export function EpisodeListEditor({
  ...
  if (episodes.length === 0) {
    return <p className="text-sm text-gray-400 text-center py-12">No episodes yet. Add your first one!</p>
  }
  ...
  return (
    <div className="space-y-2">
      {sorted.map((ep) => (
        <div key={ep.id} className="flex items-center gap-3 rounded-xl border border-white/15 bg-white/[0.02] p-3 group hover:border-purple-500/30 transition-colors">
